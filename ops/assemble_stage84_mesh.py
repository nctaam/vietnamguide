# -*- coding: utf-8 -*-
"""
VietnamGuide Stage 84: Assemble Mesh Updates
Applies all validated candidate string replacements to the host posts and saves to stage84_mesh_updates.json.
"""
import json
import os
import sys
...
from test_mesh84_candidates import CANDIDATES
...
print(f"=== Assembling Mesh Updates across {len(by_host)} Hosts ===")
...
out_file = os.path.join(ops_dir, 'stage84_mesh_updates.json')
