# -*- coding: utf-8 -*-
"""
VietnamGuide Stage 87: Assemble Mesh Updates
Applies all validated candidate string replacements to the host posts and saves to stage87_mesh_updates.json.
"""
import json
import os
import sys
...
from test_mesh87_candidates import CANDIDATES
...
print(f"=== Assembling Stage 87 Mesh Updates across {len(by_host)} Hosts ===")
...
out_file = os.path.join(ops_dir, 'stage87_mesh_updates.json')
