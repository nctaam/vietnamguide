...
Require-Matches $LiveVerifier 'vg_prepare_guide_content\s*\(\s*\$pseudo_post\s*\)\s*;' 'pseudo content fixture calls production content preparation'
Require-Matches $LiveVerifier 'vg_is_valid_guide_context\s*\(\s*\$pseudo_context\s*\)' 'pseudo context fixture validates the built guide context'
