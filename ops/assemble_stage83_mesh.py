# -*- coding: utf-8 -*-
"""
VietnamGuide Stage 83: Assemble and Strictly Validate the Internal Link Mesh
Generates verified inbound links across host posts for all 7 Stage 83 pillars.
"""
...
def main():
    targets_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'stage83_mesh_targets.json')
    ...
    replacements = {
        ...
        "hanoi-to-ha-long-bay-transport": [
            (
                ...
                '<li><a href="/plan/hanoi-to-hai-phong-transport/">Hanoi to Hai Phong Transport</a> &mdash; express trains and 5B expressway limousine vans.</li>\n<li><a href="/destinations/where-to-stay-in-hai-phong/">Where to Stay in Hai Phong</a> &mdash; French colonial hotels and central food tour bases.</li>\n<li><a href="/plan/hanoi-to-tam-dao-transport/">Hanoi to Tam Dao Transport</a> &mdash; mountain minivans and scenic routes to cloud hill stations.</li>',
                ["where-to-stay-in-hai-phong", "hanoi-to-tam-dao-transport"]
            )
        ],
        ...
        "nha-trang-to-quy-nhon-transport": [
            (
                ...
                '        <li><a href="/destinations/where-to-stay-in-quy-nhon/">Where to Stay in Quy Nhon</a>: City beach hotels vs Bai Xep fishing village homestays.</li>\n        <li><a href="/destinations/where-to-stay-in-phan-rang/">Where to Stay in Phan Rang</a>: Cham architecture lodges and Ninh Chu beach hotels.</li>',
                ["where-to-stay-in-phan-rang"]
            )
        ],
        ...
        "best-day-trips-from-hanoi": [
            (
                ...
                ["hanoi-to-tam-dao-transport", "where-to-stay-in-tam-dao"]
            )
        ],
        "hanoi-travel-guide": [
            (
        ...
        "where-to-stay-in-hanoi": [
            (
                '<a href="/destinations/cat-ba-travel-guide/">Cat Ba</a>, and <a href="/destinations/bai-tu-long-bay-guide/">Bai Tu Long Bay</a>',
                '<a href="/destinations/cat-ba-travel-guide/">Cat Ba</a>, <a href="/destinations/where-to-stay-in-tam-dao/">Tam Dao</a>, and <a href="/destinations/bai-tu-long-bay-guide/">Bai Tu Long Bay</a>',
                ["where-to-stay-in-tam-dao"]
            )
        ],
    ...
    print("=== Assembling Stage 83 Internal Link Mesh ===")
    inlink_counts = {
        "where-to-stay-in-hai-phong": 0,
        "dong-hoi-to-phong-nha-transport": 0,
        "can-tho-to-ca-mau-transport": 0,
        "where-to-stay-in-phan-rang": 0,
        "hanoi-to-tam-dao-transport": 0,
        "where-to-stay-in-tam-dao": 0,
        "kon-tum-to-da-nang-transport": 0,
    }
    ...
    print("\nVerified Inbound Links Added Per Target Pillar (from host updates):")
    ...
    if errors == 0:
        out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'stage83_mesh_updates.json')
