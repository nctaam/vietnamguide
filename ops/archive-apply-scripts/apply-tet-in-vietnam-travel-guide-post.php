...
$meta_related_routes = implode("\n", [
    ...
    'Vietnam in January | /plan/vietnam-in-january/ | Use this when the Tet lead-up sits inside January travel dates.',
    'Vietnam in February | /plan/vietnam-in-february/ | Use this when Tet peak or post-Tet restart affects a February route.',
    'Vietnam Food Safety and Street Food Etiquette | /plan/vietnam-food-safety-street-food-etiquette/ | Use this when holiday meals, markets, and changed restaurant rhythms affect food choices.',
    'Vietnam Airport Arrival Checklist | /plan/vietnam-airport-arrival-checklist/ | Use this when arriving close to Tet and first-night logistics need to be boring in the best way.',
...
<p class="vg-field-note">Use this with <a href="/plan/best-time-to-visit-vietnam/">Best Time to Visit Vietnam</a>, <a href="/plan/transport-within-vietnam/">Transport Within Vietnam</a>, Vietnam in January, Vietnam in February, <a href="/plan/vietnam-airport-arrival-checklist/">Vietnam Airport Arrival Checklist</a>, and <a href="/plan/money-cash-cards-atms/">Money in Vietnam</a> before paying for holiday-period movement.</p>
</div>
