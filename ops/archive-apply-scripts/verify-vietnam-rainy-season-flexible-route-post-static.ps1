...
$applyPath = Join-Path $repoRoot 'ops/apply-vietnam-rainy-season-flexible-route.php'
$verifyPath = Join-Path $repoRoot 'ops/verify-vietnam-rainy-season-flexible-route-post.php'
...
Require-File 'Vietnam rainy season static verifier' $staticPath
Require-File 'Vietnam rainy season post apply script' $applyPath
Require-File 'Vietnam rainy season post runtime verifier' $verifyPath
...
Require-Contains 'Apply script targets expected slug' $apply 'vietnam-rainy-season-flexible-route'
...
Require-Contains 'Apply script checks target meta' $apply 'vg_rainy_post_assert_target_meta'
Require-Contains 'Apply script checks exact target date before overwrite' $apply "'vg_editorial_target_publish_date' => '2026-08-10'"
...
Require-Contains 'Runtime verifier checks exact target date' $verify '2026-08-10'
...
Write-Output 'Vietnam rainy season static checks passed.'
