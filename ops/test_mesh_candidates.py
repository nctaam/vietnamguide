# -*- coding: utf-8 -*-
"""
VietnamGuide Stage 82 Mesh Builder Test
Tests candidate replacement strings on stage82_mesh_targets.json
"""

import json
import os

targets = json.load(open('ops/stage82_mesh_targets.json', encoding='utf-8'))

# List of replacements: (host_slug, old_str, new_str, target_pillar_slug)
candidates = [
    # === Pillar 1: hoi-an-to-quy-nhon-transport ===
    (
    ...
    # === Pillar 2: hanoi-to-hai-phong-transport ===
    (
    ...
    # === Pillar 3: can-tho-to-ha-tien-transport ===
    (
    ...
    # === Pillar 4: buon-ma-thuot-to-nha-trang-transport ===
    (
    ...
    # === Pillar 5: where-to-stay-in-bac-lieu ===
    (
    ...
    # === Pillar 6: where-to-stay-in-ca-mau ===
    (
        "where-to-stay-in-soc-trang",
    ...
    # === Pillar 7: vietnam-train-vs-flight ===
    (
